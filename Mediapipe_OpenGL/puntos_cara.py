...
# Lista de índices de landmarks específicos (puntos de boca )

selected_points = [33, 133, 362, 263, 4, 61, 291, 0, 17]
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            if 33 in puntos and 133 in puntos:
                ...
                cv2.putText(
                    frame,
                    f" {int(puntos[61][0] - 20), int(puntos[61][1] - 20)}",
