...
from OpenGL.GLU import gluCylinder, gluLookAt, gluNewQuadric, gluPerspective, gluSphere
...
def draw_scene():
    ...
    gluLookAt(
        camera_pos[0],
        camera_pos[1],
        camera_pos[2],  # Posición de la cámara
        camera_target[0],
        camera_target[1],
        camera_target[2],  # Punto al que mira
        camera_up[0],
        camera_up[1],
        camera_up[2],
    )  # Vector hacia arriba
